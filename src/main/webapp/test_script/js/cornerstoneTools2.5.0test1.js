...
function updatePerpendicularLineHandles (eventData, data) {
    ...
    let startX, startY, endX, endY,startX2, startY2, endX2, endY2,startX3, startY3, endX3, endY3;
...
function drawPerpendicularLine (context, element, data, color, lineWidth) {
    // Draw perpendicular line
    var { perpendicularStart, perpendicularEnd, perpendicularStart2, perpendicularEnd2 , perpendicularStart3, perpendicularEnd3} = data.handles;
...
function calculateLongestAndShortestDiameters (eventData, measurementData) {
    var { rowPixelSpacing, columnPixelSpacing } = eventData.image;
    var { start, end, perpendicularStart, perpendicularEnd, perpendicularStart2, perpendicularEnd2 , perpendicularStart3, perpendicularEnd3} = measurementData.handles;
	...
	measurementData.shortestDiameter2 = width4.toFixed(1);
	//measurementData.shortestDiameter3 = width3.toFixed(1);
	measurementData.ctr = Math.round(width4/width*100)/100;
}
